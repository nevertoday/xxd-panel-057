...
# 🦁 XXD Panel 057｜기하학적 기억의 장

### 기하 구성과 지능형 모자이크로 사진을 고요하고 따뜻한 현대 콜라주로 재구성
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 057 Sample 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 057 Sample 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 057 Sample 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 057 Sample 8"></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 057 additional top-bottom sample 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 057 additional top-bottom sample 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 057 additional top-bottom sample 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 057 additional top-bottom sample 4"></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 057 예시 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 057 예시 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 057 예시 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 057 예시 8"></td>
  </tr>
</table>

## 3:4 세로형 상하 구성 예시

위 16:9 예시와 같은 네 개의 독립 소스를 완전한 3:4 상하 캔버스로 다시 생성했습니다. 위쪽은 현실 사진을 유지하고 아래쪽은 Panel 057의 원본 프롬프트에 따라 재구성합니다. 영어 문구는 각 사진의 내용·분위기·함의에서만 생성했으며 모든 결과를 개별 검수했습니다.

<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 057 추가 상하 예시 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 057 추가 상하 예시 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 057 추가 상하 예시 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 057 추가 상하 예시 4"></td>
  </tr>
</table>

> [샤오샤오둥（@xiaoxiaodong01）](https://x.com/xiaoxiaodong01/status/2092160522711978218) · 2026년 8월 25일<br>
> GPT2 × 기하 × 치유 콜라주 × 미학 프롬프트 × VOL.057

<p align="center"><a href="https://x.com/xiaoxiaodong01/status/2092160522711978218">원문 게시물과 전체 프롬프트 보기 →</a></p>

이 예시는 057의 미학적 결과만 보여 줍니다. 예시의 주제, 구성, 색상, 문구, 이전 캔버스 비율은 새 작업의 참고나 기본값이 되지 않습니다.

기하 구성 · 지능형 모자이크 · 건축 도해 · 아트 맵 · 온냉 색면
...
**Panel 057**은 원본 사진의 핵심을 보존하면서 다음과 같은 시각 방향을 원하는 작업에 적합합니다: **기하 구성과 지능형 모자이크로 사진을 고요하고 따뜻한 현대 콜라주로 재구성**. 먼저 용도와 원하는 결과를 확인한 뒤 구성, 크기, 텍스트와 전달 형식을 결정합니다.
...
> XXD Panel 057으로 이 이미지를 작업하고, 먼저 가장 어울리는 구성과 크기를 추천해 줘.
...
| 궁금한 점 | 이 스타일이 주는 답 |
|---|---|
| **얻게 되는 결과** | 기하 구성과 지능형 모자이크로 사진을 고요하고 따뜻한 현대 콜라주로 재구성 |
| **한눈에 알아볼 특징** | 기하 구성 · 지능형 모자이크 · 건축 도해 · 아트 맵 · 온냉 색면 |
...
```bash
git clone https://github.com/nevertoday/xxd-panel-057.git
mkdir -p ~/.codex/skills
ln -s "$(pwd)/xxd-panel-057" ~/.codex/skills/xxd-panel-057
```

`npx skills`로도 바로 설치할 수 있습니다:

```bash
npx skills add https://github.com/nevertoday/xxd-panel-057 --skill xxd-panel-057
```
...
Claude Code 사용자는 같은 폴더를 다음 위치에 연결할 수 있습니다: `~/.claude/skills/xxd-panel-057`. 설치 후 에이전트 세션을 다시 시작하세요.
...
사진을 성립시키는 주체, 윤곽, 자세, 서사 관계를 판단하고 불필요한 환경을 덜어 낸 뒤 기억할 가치가 있는 정보만 명확한 기하 모듈로 재구성합니다. 무작위 픽셀화도, 모든 물체를 하나씩 일러스트로 바꾸는 필터도 아닙니다.

```text
정체성·윤곽·핵심 관계 고정 → 불필요한 환경과 세부 삭제 → 기억할 정보를 추출 → 기하 면·직사각형 단위·층형 그리드로 압축 → 흰색에 가까운 여백으로 공기와 거리 형성 → 온냉 색면·축선·정렬로 지능형 모자이크 구성 → 의미 있는 최소 글자 통합
```

## 완성작에서 바로 알아볼 수 있는 스타일 특징

- 큰 형태는 알아볼 수 있는 윤곽을 유지하고 세부는 질서 있는 색면, 격점, 조각, 계단형 가장자리, 국소 결합으로 바뀝니다.
- 직사각형 단위, 가는 선 프레임, 층형 그리드, 부분 축선과 정렬선이 픽셀 노이즈가 아닌 건축적 질서를 만듭니다.
- 원본 색온도에 맞춰지는 흰색에 가까운 배경과 넓은 음의 공간이 기하 주체를 가볍고 깨끗하며 고요하게 보이게 합니다.
...
이미지 폴더를 직접 전달하면 이 병사 Skill이 같은 Panel 057의 원본 미학으로 일괄 처리합니다. 일반 래스터 형식을 기본적으로 재귀 탐색하고 수량을 먼저 알린 뒤 모드·크기·텍스트·언어를 한 번만 확인합니다. 각 이미지는 내용이나 문구가 섞이지 않도록 독립 생성하며 전체 배치는 하나의 평면 작업 디렉터리만 사용합니다. 개별 실패는 기록하고 이후 이미지를 조용히 누락하지 않습니다.
...
```text
/xxd-panel-057 photo.jpg --mode top-bottom,design-only --size auto,3:4,9:16 --text prompt --locale ja-JP
```
...
```text
/xxd-panel-057 photo.jpg --prefs last
/xxd-panel-057 photo.jpg --prefs edit
/xxd-panel-057 photo.jpg --prefs new
```
...
/xxd-panel-057 photo.jpg --mode top-bottom --size auto --text prompt --locale ko-KR

# 좌우 비교: 3:2 가로형, 글자 없음
/xxd-panel-057 photo.jpg --mode left-right --size 3:2 --text none

# 디자인 전용: 9:16 휴대폰 세로형, 한국어 문구
/xxd-panel-057 photo.jpg --mode design-only --size 9:16 --text prompt --locale ko-KR

# 연결형 4종 배경화면: 기준 이미지 후 기기별 재구성
/xxd-panel-057 photo.jpg --mode wallpaper-pack --wallpaper linked --text none

# 독립형 배경화면: 기기별 정확한 해상도 지정
/xxd-panel-057 photo.jpg --mode wallpaper-pack --wallpaper independent --wallpaper-size phone=1440x3200,ipad=2048x2732,desktop=3840x2160,watch=1024x1024 --text none

# 원본 이미지 비율 따르기
/xxd-panel-057 photo.jpg --mode design-only --size source --text none

# 정사각형·세로·가로 완성 구도를 각각 생성
/xxd-panel-057 photo.jpg --mode design-only --size 1:1,3:4,16:9 --text none

# 사용자 비율과 정확한 픽셀을 함께 지정
/xxd-panel-057 photo.jpg --mode design-only --size 11:14,2160x3840,3840x2160 --text none

# 원본 프롬프트가 문구를 만들고 언어만 제한
/xxd-panel-057 photo.jpg --mode design-only --size 3:4 --text prompt --locale ko-KR

# 정확한 문구를 재작성·번역·제목 추가 없이 사용
/xxd-panel-057 photo.jpg --mode design-only --size 3:4 --copy "빛을 이곳에 남겨 두기" --locale ko-KR

# 2개 모드 × 3개 크기로 독립적인 완성 구도 6개 생성
/xxd-panel-057 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ko-KR

# 폴더 전체에 Panel 057 적용, 공통 설정은 한 번만 확정
/xxd-panel-057 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ko-KR

# 반복 매개변수도 누적하며 지정 루트 아래로 출력
/xxd-panel-057 photo.jpg --mode top-bottom --mode left-right --size 3:4 --size 16:9 --text none --out ./deliveries
```
