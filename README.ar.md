...
# 🦁 XXD Panel 057｜حقل الذاكرة الهندسي

### إعادة بناء الصور ككولاجات حديثة هادئة ودافئة عبر التكوين الهندسي والفسيفساء الذكية
...
<table>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2092160522711978218"><img src="./assets/examples/sample-01.jpg" alt="XXD Panel 057 نموذج 1"></a></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 057 نموذج 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 057 نموذج 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 057 نموذج 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 057 نموذج 8"></td>
  </tr>
</table>

## نماذج إضافية 3:4 بتكوين أعلى–أسفل

تعيد هذه الأعمال الأربعة استخدام المصادر المستقلة نفسها في مجموعة 16:9 أعلاه، لكن داخل لوحات كاملة 3:4 بتكوين أعلى–أسفل. تبقى الصورة الواقعية في الأعلى، ويُعاد بناء التصميم السفلي وفق الموجّه الأصلي لـ Panel 057. لا يُولَّد النص الإنجليزي إلا من محتوى كل صورة أو مزاجها أو دلالتها، وقد روجعت النتائج واحدةً واحدة.

<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 057 نموذج إضافي أعلى–أسفل 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 057 نموذج إضافي أعلى–أسفل 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 057 نموذج إضافي أعلى–أسفل 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 057 نموذج إضافي أعلى–أسفل 4"></td>
  </tr>
</table>

> [Xiaoxiaodong (@xiaoxiaodong01)](https://x.com/xiaoxiaodong01/status/2092160522711978218) · 25 أغسطس 2026<br>
> GPT2 × هندسة × كولاج مريح × موجّه جمالي × VOL.057

<p align="center"><a href="https://x.com/xiaoxiaodong01/status/2092160522711978218">عرض المنشور الأصلي والتوجيه كاملاً ←</a></p>

تعرض هذه النماذج النتيجة الجمالية للإصدار 057 فقط؛ ولا تصبح موضوعاتها أو تكوينها أو ألوانها أو نصوصها أو نسبة اللوحة السابقة مراجع أو إعدادات افتراضية لمهمة جديدة.

تكوين هندسي · فسيفساء ذكية · مخطط معماري · خريطة فنية · حقول لونية دافئة وباردة

يستخرج من الصورة الموضوع والهيئة والعلاقات الجديرة بالتذكّر، ثم يضغطها في مساحات هندسية ووحدات مستطيلة وأطر رفيعة وشبكات طبقية. يوازن الفراغ القريب من الأبيض والحقول الدافئة والباردة بين منطق الرسم المعماري ودفء الذاكرة.
...
يناسب **Panel 057** الأعمال التي تحتاج إلى الاحتفاظ بجوهر الصورة الأصلية مع السعي إلى هذا الاتجاه البصري: **إعادة بناء الصور ككولاجات حديثة هادئة ودافئة عبر التكوين الهندسي والفسيفساء الذكية**. يبدأ من الاستخدام المقصود والنتيجة المطلوبة، ثم يحدد التكوين والمقاس والنص وصيغة التسليم.
...
> استخدم XXD Panel 057 لهذه الصورة، واقترح أولاً أنسب تكوين ومقاس.
...
## تحقق سريع: هل XXD Panel 057 مناسب لك؟

| ما الذي يهمك؟ | ما الذي يقدمه هذا الأسلوب؟ |
|---|---|
| **النتيجة التي ستحصل عليها** | إعادة بناء الصور ككولاجات حديثة هادئة ودافئة عبر التكوين الهندسي والفسيفساء الذكية |
| **السمات التي تُعرف من النظرة الأولى** | تكوين هندسي · فسيفساء ذكية · مخطط معماري · خريطة فنية · حقول لونية دافئة وباردة |
...
يحدد الأسلوب الموضوع والهيئة والوضع والعلاقات السردية التي تجعل الصورة متماسكة، ويحذف البيئة غير المهمة، ثم يعيد تنظيم المعلومات الجديرة بالتذكّر في وحدات هندسية واضحة. إنه ليس تنقيطاً عشوائياً ولا مرشحاً يحوّل كل عنصر إلى رسم مستقل.

```text
تثبيت الهوية والهيئة والعلاقات الأساسية ← حذف البيئة والتفاصيل غير المهمة ← استخلاص ما يستحق التذكّر ← ضغطه في مساحات هندسية ووحدات مستطيلة وشبكات طبقية ← بناء الهواء والمسافة بفراغ قريب من الأبيض ← إنشاء فسيفساء ذكية عبر الحقول الدافئة والباردة والمحاور والمحاذاة ← دمج أقل قدر من النص ذي المعنى
```

## سمات الأسلوب التي تظهر بوضوح في النتيجة

- تحتفظ الكتل الكبيرة بهيئات واضحة، بينما تتحول التفاصيل إلى حقول لونية ونقاط شبكة وشرائح وحواف متدرجة وتشابكات محلية منظّمة.
- تصنع الوحدات المستطيلة والأطر الرفيعة والشبكات الطبقية والمحاور الجزئية وخطوط المحاذاة نظاماً معمارياً بدلاً من ضجيج البكسلات.
- تحافظ أرضية قريبة من الأبيض ومتجاوبة مع حرارة المصدر، مع فراغ سلبي واسع، على خفة الموضوع الهندسي ونظافته وهدوئه.
- تلتقي الكريمي والمشمشي والخوخي والمرجاني والوردي الغباري مع السماوي والمائي الفاتح والنعناعي والأخضر الهادئ في توازن دافئ وبارد مضبوط.
- يمكن أن يكون الموضوع لامركزياً أو معلقاً أو منخفضاً أو متجمعاً عبر طبقات؛ وتنتمي الكتابة الرفيعة إلى الفراغ والهندسة بدلاً من قالب عنوان ثابت.

لا توجد القيود الجمالية وقواعد الرفض إلا في [الموجّه الأصلي](references/original-prompt/zh-CN.md)، أما المهارة ومهايئ التشغيل فيعالجان متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-057-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 057. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-057 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-057 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-057 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-057 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-057 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 057 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-057 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-057`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-057-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-057-prompt.zh-CN.md)
