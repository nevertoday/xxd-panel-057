...
# 🦁 XXD Panel 057｜幾何学の記憶の場

### 幾何構成とインテリジェント・モザイクで、写真を静かで温かな現代コラージュへ再構成
...
<table>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2092160522711978218"><img src="./assets/examples/sample-01.jpg" alt="XXD Panel 057 作例 1"></a></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 057 作例 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 057 作例 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 057 作例 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 057 作例 8"></td>
  </tr>
</table>

## 3:4 縦長・上下構成の作例

16:9 組とは別の独立した4点で、3:4 上下の完成キャンバスを生成。上部は現実の写真を保ち、下部は Panel 057 の原文プロンプトに従って再構成しています。英語コピーは各写真の内容・空気・含意だけから生成し、全点を個別に確認しました。

<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 057 追加上下作例 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 057 追加上下作例 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 057 追加上下作例 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 057 追加上下作例 4"></td>
  </tr>
</table>

> [小小東（@xiaoxiaodong01）](https://x.com/xiaoxiaodong01/status/2092160522711978218) · 2026年8月25日<br>
> GPT2 × 幾何 × 癒やし系コラージュ × 美学プロンプト × VOL.057

<p align="center"><a href="https://x.com/xiaoxiaodong01/status/2092160522711978218">元の投稿と完全なプロンプトを見る →</a></p>

これらの作例は 057 の美的成果だけを示します。作例の被写体、構図、配色、文字、旧キャンバス比率が、新しいタスクの参照や既定値になることはありません。

幾何構成 · インテリジェント・モザイク · 建築図解 · アートマップ · 暖冷の色面
...
**Panel 057** は、原写真の核を保ちながら、次の視覚方向を目指す制作に向いています：**幾何構成とインテリジェント・モザイクで、写真を静かで温かな現代コラージュへ再構成**。まず用途と期待する結果を確認し、そこから構図、サイズ、文字、納品形式を決めます。
...
> XXD Panel 057 でこの画像を処理して、まず最適な構図とサイズを提案して。
...
| 知りたいこと | このスタイルの答え |
|---|---|
| **得られる完成作品** | 幾何構成とインテリジェント・モザイクで、写真を静かで温かな現代コラージュへ再構成 |
| **ひと目で分かる特徴** | 幾何構成 · インテリジェント・モザイク · 建築図解 · アートマップ · 暖冷の色面 |
...
Claude Code では同じフォルダを次へリンクできます： `~/.claude/skills/xxd-panel-057`. インストール後に Agent セッションを再起動してください。
...
画像フォルダーを直接渡すと、この兵士 Skill が同じ Panel 057 の原文美学で一括処理します。一般的なラスター形式を既定で再帰検索し、件数を報告してから、モード・サイズ・文字・言語を一度だけ確認します。各画像は内容や文言を混ぜず独立生成し、バッチ全体は一つのフラットなタスクフォルダーへ保存します。個別の失敗は記録し、後続画像を黙って省略しません。
...
/xxd-panel-057 photo.jpg --mode top-bottom --size auto --text prompt --locale ja-JP

# 左右比較：3:2 横長、文字なし
/xxd-panel-057 photo.jpg --mode left-right --size 3:2 --text none

# デザインのみ：9:16 スマートフォン縦長、日本語文字
/xxd-panel-057 photo.jpg --mode design-only --size 9:16 --text prompt --locale ja-JP
...
/xxd-panel-057 photo.jpg --mode design-only --size 3:4 --text prompt --locale ja-JP

# 正確な文言を、書き換え・翻訳・タイトル追加なしで使用
/xxd-panel-057 photo.jpg --mode design-only --size 3:4 --copy "光をここに残す" --locale ja-JP

# 2モード × 3サイズで独立した完成構図を6枚生成
/xxd-panel-057 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ja-JP

# フォルダー全体へ Panel 057 を適用し、共通設定は一度だけ解決
/xxd-panel-057 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ja-JP
